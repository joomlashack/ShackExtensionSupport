...
class PlgSystemOSMyLicensesManagerTest extends \Codeception\Test\Unit
{
    ...
    /**
     * The plugin should ignore third party URLs on the event
     * onInstallerBeforePackageDownload.
     */
    public function testIgnoringThirdPartyUrlOnInstallerBeforePackageDownload()
    {
    ...
    {
        $url         = 'https://deploy.ostraining.com/client/download/free/stable/com_dummy/';
        $originalURL = $url;
        $headers     = array();
